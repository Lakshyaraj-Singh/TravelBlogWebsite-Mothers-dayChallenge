        ...
        <div className="navbar-end gap-2">
          <div className="searchArticles flex flex-col gap-3 relative">
            ...
            {allArticles.length > 0 && (
              <div className="flex flex-col gap-1 overflow-y-scroll absolute max-h-80 w-72 md:w-127  left-20 md:left-0 md:right-1 z-50 top-17 bg-white rounded shadow-md p-2">
